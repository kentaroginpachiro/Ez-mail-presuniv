...
public class DewanEtik extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dewan_etik);
        TextView descTextView = findViewById(R.id.desc);
        String description = getString(R.string.dewan_desc);
    ...
    public void sendEmail(View view) {
        String email = "ethics@president.ac.id";
